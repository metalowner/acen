var robotPassion = 'Adventures';
var Profile = {
	userName: 'Bob Marley',
	userLifeStory: {
		childhood: `Bob Marley was born 6 February 1945 on the farm of his maternal grandfather 
				in Nine Mile, Saint Ann Parish, Jamaica, to Norval Sinclair Marley (1885–1955) 
				and Cedella Booker (1926–2008). Norval Marley was a white Jamaican originally 
				from Sussex, England, whose family claimed Syrian Jewish origins. 
				Norval claimed to have been a captain in the Royal Marines; at the time of his marriage to Cedella Booker, 
				an Afro-Jamaican then 18 years old. He was employed as a plantation overseer. 
				Bob Marley's full name is Robert Nesta Marley, though some sources give his birth name as Nesta Robert Marley, 
				with a story that when Marley was still a boy a Jamaican passport official reversed his first and middle names 
				because Nesta sounded like a girl's name. 
				Norval provided financial support for his wife and child but 
				seldom saw them as he was often away. 
				Bob Marley attended Stepney Primary and Junior High School 
				which serves the catchment area of Saint Ann. 
				In 1955, when Bob Marley was 10 years old, his father died of a heart attack at the age of 70. 
				Marley's mother went on to marry Edward Booker, an American civil servant. 
				The relationship brought Marley two American brothers: Richard and Anthony.
				...
				Cedella Booker and Thadeus Livingston (Bunny Wailer's father) had a daughter together whom 
				they named Claudette Pearl, who was a younger sister to both Bob and Bunny. 
				Now that Marley and Livingston were living together in the same house in Trenchtown, 
				their musical explorations deepened to include the latest R&B from American radio stations 
				whose broadcasts reached Jamaica, and the new Ska music. 
				The move to Trenchtown was proving to be fortuitous, 
				and Marley soon found himself in a vocal group with Bunny Wailer, Peter Tosh, Beverley Kelso and Junior Braithwaite. 
				Joe Higgs, who was part of the successful vocal act Higgs and Wilson, resided on 3rd St., 
				and his singing partner Roy Wilson had been raised by the grandmother of Junior Braithwaite. 
				Higgs and Wilson would rehearse at the back of the houses between 2nd and 3rd Streets, 
				and it wasn't long before Marley (now residing on 2nd St), Junior Braithwaite and the others were congregating around this successful duo. 
				Marley and the others didn't play any instruments at this time, and were more interested in being a vocal harmony group. 
				Higgs was glad to help them develop their vocal harmonies, although more importantly, 
				he had started to teach Marley how to play guitar—thereby creating the bedrock that would later allow Marley 
				to construct some of the biggest-selling reggae songs in the history of the genre.`,
		passion: `Musical career
				1962–72: Early years
				In February 1962, Marley recorded four songs, "Judge Not", "One Cup of Coffee", 
				"Do You Still Love Me?" and "Terror", at Federal Studio for local music producer Leslie Kong. 
				Three of the songs were released on Beverley's with "One Cup of Coffee" being released under the pseudonym Bobby Martell.

				In 1963, Bob Marley, Bunny Wailer, Peter Tosh, Junior Braithwaite, Beverley Kelso, and Cherry Smith were called the Teenagers. 
				They later changed the name to the Wailing Rudeboys, then to the Wailing Wailers, at which point they were discovered 
				by record producer Coxsone Dodd, and finally to the Wailers. Their single "Simmer Down" for the Coxsone label became a 
				Jamaican #1 in February 1964 selling an estimated 70,000 copies. 
				The Wailers, now regularly recording for Studio One, found themselves working with established Jamaican musicians such as 
				Ernest Ranglin (arranger "It Hurts To Be Alone"), the keyboardist Jackie Mittoo and saxophonist Roland Alphonso. 
				By 1966, Braithwaite, Kelso, and Smith had left the Wailers, leaving the core trio of Bob Marley, Bunny Wailer, and Peter Tosh.

				In 1966, Marley married Rita Anderson, and moved near his mother's residence in Wilmington, 
				Delaware in the United States for a short time, during which he worked as a DuPont lab assistant and on the assembly line at a 
				...
				The Rastafari proscription against cutting hair is based on the biblical Samson, who as a Nazirite, was expected to make certain religious vows, 
				including the ritual treatment of his hair as described in Chapter Six of the Book of Numbers: "All the days of the vow of his separation there 
				shall no razor come upon his head: until the days be fulfilled, in the which he separateth himself unto the Lord, he shall be holy, 
				and shall let the locks of the hair of his head grow."(Numbers 6: 5 KJV)

				After a financial disagreement with Dodd, Marley and his band teamed up with Lee "Scratch" Perry and his studio band, the Upsetters. 
				...
				The new beat was a slow, steady, ticking rhythm that was first heard on the Maytals song "Do the Reggay." 
				Marley approached producer Leslie Kong, who was regarded as one of the major developers of the reggae sound. 
				For the recordings, Kong combined the Wailers with his studio musicians called Beverley's All-Stars, 
				which consisted of the bassists Lloyd Parks and Jackie Jackson, the drummer Paul Douglas, the keyboard players Gladstone Anderson and Winston Wright, 
				and the guitarists Rad Bryan, Lynn Taitt, and Hux Brown. 
				As David Moskowitz writes, "The tracks recorded in this session illustrated the Wailers’ earliest efforts in the new reggae style. 
				Gone are the ska trumpets and saxophones of the earlier songs, with instrumental breaks now being played by the electric guitar." 
				The songs recorded would be released as the album The Best of The Wailers, including tracks "Soul Shakedown Party," 
				"Stop That Train," "Caution," "Go Tell It on the Mountain," "Soon Come," "Can’t You See," "Soul Captives," "Cheer Up," "Back Out," and "Do It Twice".
				...
				Bunny later asserted that these songs "should never be released on an album ... they were just demos for record companies to listen to". 
				In 1968, Bob and Rita visited songwriter Jimmy Norman at his apartment in the Bronx. 
				Norman had written the extended lyrics for Kai Winding's "Time Is on My Side" (covered by the Rolling Stones) and had also written for Johnny Nash and Jimi Hendrix. 
				A three-day jam session with Norman and others, including Norman's co-writer Al Pyfrom, resulted in a 24-minute tape of Marley performing several of his own and Norman-Pyfrom's compositions. 
				This tape is, according to Reggae archivist Roger Steffens, rare in that it was influenced by pop rather than reggae, as part of an effort to break Marley into the American charts. 
				...
				Since Jimmy Cliff, Island's top reggae star, had recently left the label, Blackwell was primed for a replacement. 
				In Marley, Blackwell recognised the elements needed to snare the rock audience: "I was dealing with rock music, which was really rebel music. 
				I felt that would really be the way to break Jamaican music. But you needed someone who could be that image. When Bob walked in he really was that image." 
				...
				Blackwell desired to create "more of a drifting, hypnotic-type feel than a reggae rhythm", and restructured Marley's mixes and arrangements. 
				...
				Eric Clapton was given the album by his guitarist George Terry in the hope that he would enjoy it. 
				Clapton was suitably impressed and chose to record a cover version of "I Shot the Sheriff" which became his first US hit since "Layla" two years earlier and reached number 1 on the Billboard Hot 100 on 14 September 1974.
				...
				The reason for the breakup is shrouded in conjecture; some[who?] believe that there were disagreements amongst Bunny Wailer, Peter Tosh, and Marley concerning performances, while others claim that Wailer and Tosh simply preferred solo work.
				...
				On 3 December 1976, two days before "Smile Jamaica", a free concert organised by the Jamaican Prime Minister Michael Manley in an attempt to ease tension between two warring political groups, Marley, his wife, and manager Don Taylor were wounded in an assault by unknown gunmen inside Marley's home. 
				...
				When asked why, Marley responded, "The people who are trying to make this world worse aren't taking a day off. 
				How can I?" The members of the group Zap Pow played as Bob Marley's backup band before a festival crowd of 80,000 while members of The Wailers were still missing or in hiding.
				...
				The releases included Babylon by Bus, a double live album with 13 tracks, were released in 1978 and received critical acclaim. 
...
var BotMessages = ['Hi user! My name is Pal and I am your Acen guide. I will be analyzing your input and suggesting activities.'];

var Questions = [{
		questionNumber: 1,
		questionTitle: 'Best day!',
		questionDescription: 'Tell me about the best day you ever had.'
	},
	{
		questionNumber: 2,
		questionTitle: 'Best event!',
